rule deseq2_prep:
    ...
    output:
        ...
        product_annotation = "/home/marc/projects/rna_seq_workflow/results/feature_counts/{run_id}_product_annotation.csv"
    log:
        filtered = "/home/marc/projects/rna_seq_workflow/reports/{run_id}_abundance_filter.log"
    conda:
